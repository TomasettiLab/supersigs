...
supersigs is a companion R package to a method proposed by *Afsari, et al.* (https://doi.org/10.7554/eLife.61082), which generates tissue-specific mutational signatures for the cancer genome.
